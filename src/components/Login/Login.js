...
function Login() {
  ...
  return (
    <div style={{ textAlign: "center" }}>
      ...
      {newUser === false ? <h4>Login</h4> : <h4>Create an account</h4>}
      ...
      {user.success && (
        <p style={{ color: "green" }}>
          Your account {newUser ? "created" : "Log In"} successfully
        </p>
      )}
      <h4>------------ or -------------- </h4>
      <div login-btn>
        ...
        <br />
        <button className="btn btn-success " onClick={handleFbSignIn}>
