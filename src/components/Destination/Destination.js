    ...
    <div className="container row ">
      <div className="col-md-6">
        <form className="sign-up">
          {search && (
            <div className="form-group cardBody">
              <div className="">
                <label htmlFor="form" className="form-label text-white">
                  Date
                </label>
                <input
                  type="date"
              ...
              <div className="">
                ...
                <input
                  onBlur={handleDastination}
                  name="from"
                  type="text"
                  className="form-control"
                  placeholder="Enter Your From Place"
                  required
                />
              </div>
              <div className="form-group">
                ...
                <input
                  ...
                  type="text"
                  className="form-control"
                  placeholder="Enter Your To Place"
                  required
                />
              </div>
              <div
          ...
          {!search && (
            <div className="form-group">
              ...
              <div
                className="card-body row-md cardBody"
                style={{ display: "flex" }}
              >
                ...
                <div
                  style={{ maxWidth: "40%", margin: "20px", maxHeight: "50px" }}
                >
                  <h3>{name}</h3>
                </div>
                <div
      ...
      <div className="col-md-6">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m28!1m12!1m3!1d930695.3880192137!2d89.12919296833891!3d24.32806375246765!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m13!3e6!4m5!1s0x39fc54e7e81df441%3A0x27133ed921fe73f4!2sBogura!3m2!1d24.848077999999997!2d89.3729633!4m5!1s0x3755b8b087026b81%3A0x8fa563bbdd5904c2!2sDhaka!3m2!1d23.810332!2d90.4125181!5e0!3m2!1sen!2sbd!4v1616245206231!5m2!1sen!2sbd"
          style={{
            width: "100%",
            height: "500px",
            border: 0,
